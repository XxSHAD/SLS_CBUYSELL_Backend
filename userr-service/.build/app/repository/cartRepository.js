...
class CartRepository extends dbOperation_1.DBOperation {
    ...
    findCartItemByProductId(productId, cartId) {
        return __awaiter(this, void 0, void 0, function* () {
            const queryString = "SELECT product_id, price, item_qty FROM cart_items WHERE product_id=$1 AND cart_id=$2";
    ...
    findCartItemsByCartId(cartId) {
        return __awaiter(this, void 0, void 0, function* () {
            const queryString = "SELECT product_id, name, price, item_qty FROM cart_items WHERE cart_id=$1";
            const values = [cartId];
            const result = yield this.executeQuery(queryString, values);
    ...
    createCartItem(_a) {
        return __awaiter(this, arguments, void 0, function* ({ cart_id, product_id, name, image_url, price, item_qty }) {
    ...
    deleteCartItem(id) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const values = [id];
            return yield this.executeQuery(queryString, values);
        });
    }
}
